...
import { pricing_health } from "@/data/pricing-data";
      ...
      <Layout topHeader>
        <div className="">
          <HomeBanner
            ...
            gradient="bg-gradient-health-bottom"
            brochure="/assets/pdf/health.pdf"
          />
          <ForumRegister gradient="text_h_gradient" />
          <ForumTracks gradient="text_h_gradient" />
          <Venue gradient="text_h_gradient" />
          <FaqArea faq={faq} gradient="text_h_gradient" />
          <Pricing
            title="Register Now"
            ...
            themebg="gradient-health"
            earlyBg
            gradient="text_h_gradient"
            pricing_data={pricing_health}
          />
        </div>
      </Layout>
    </Wrapper>
